...
<body class="bg-gradient-to-t from-cyan-100 to-teal-50 min-h-screen">
    ...
    <main class="flex-1 ml-64 p-8 mt-20 ">
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
            <form action="aksi_tambah_transaksi.php" method="POST" class="space-y-6">
                <div>
                    <label for="id_user" class="block text-sm font-medium text-gray-700">Nama User</label>
                    <input type="text" name="id_user" id="id_user" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-primary focus:border-blue-primary">
                </div>
                <div>
                ...
                <div>
                    <label for="jumlah" class="block text-sm font-medium text-gray-700">Jumlah Buku Dipinjam</label>
                    <input type="number" name="jumlah" id="jumlah" min="1" required class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:ring-blue-primary focus:border-blue-primary">
                </div>
                <div>
                ...
                <div>
                    <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 transition">Tambah Peminjaman</button>
                </div>
            </form>
        </div>
    </main>
