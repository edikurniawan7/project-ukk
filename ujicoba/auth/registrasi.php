    ...
    <div class="w-full max-w-sm">
        ...
        <div class="bg-white p-12 rounded-2xl shadow-2xl">
            <form method="post" action="../aksi/aksi_registrasi.php" id="registrasiForm" class="space-y-6">
                ...
                <!-- Full Name Field -->
                <div>
                    <label for="full_name" class="block text-sm font-medium text-gray-700 mb-3">
                        Nama Lengkap
                    </label>
                    <div class="relative">
                        <img 
                ...
                <button
                    type="submit"
                    class="w-full bg-teal-primary hover:bg-teal-secondary text-white font-semibold py-2.5 px-4 rounded-lg transition transform hover:scale-105 shadow-md"
                >
                    Daftar
                </button>
